export default function Landing() {
  return (
    <div className="bg-[url('../src/Pages/Landing/oldlady.jpeg')] bg-no-repeat mx-auto h-[500px] bg-cover flex items-center justify-center">
      <div className="h-1/2 absolute left-10 bg-gradient-to-r from-transparent to-white w-2/5 p-8 rounded-lg shadow-md flex flex-col items-start justify-start space-y-4">
